 ...
 * @author TUAN
 */
@WebServlet("Login")//xai post de luu du lieu an toan
public class LoginController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher //
                = this.getServletContext().getRequestDispatcher("/WEB-INF/jsp/lgin.jsp");
	        ...
	        if(username.isEmpty() || password.isEmpty()){
                ...
                if(checklogin==true)
                {
                    if(checkadmin==true)
                    {
                        ...
                        req.getRequestDispatcher("/WEB-INF/admin/home.jsp").forward(req, resp);//login admin
                    }
                    else//login la client
                    {
                        ...
                        req.setAttribute("user", user);
                        req.getRequestDispatcher("WEB-INF/jsp/home.jsp").forward(req, resp);//gui user va cart den home
                    }
                }
                else//sai
                {
